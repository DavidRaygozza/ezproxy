$.getJSON("https://api.openweathermap.org/data/2.5/weather?q=la%20verne&units=imperial&appid=689d3bd03d9f7dab20870a5f4da956ee", function(data){
    ...
    $(".weather").css({"padding": "5px", "position": "absolute", "top":"5%", "left":"5%", "color":"#FFFFFF", "background-color":"#626ed4", "display":"flex", "flex-direction":"row", "align-content":"center", "border-radius":"40px"});
